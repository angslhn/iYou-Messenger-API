...
/**
 * Middleware khusus untuk membatasi laju permintaan (rate limiting) pada endpoint login.
 * Bertujuan untuk melindungi sistem dari serangan Brute Force dan Credential Stuffing.
 * Jika sebuah IP melampaui batas percobaan login yang ditentukan, sistem akan
...
const loginLimiter: RateLimitRequestHandler = rateLimit({
  ...
  windowMs: env.LOGIN_LIMIT_DURATION_TIME,
