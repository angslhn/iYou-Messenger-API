...
/**
 * Middleware khusus untuk membatasi laju permintaan (rate limiting) pada endpoint register.
 * Bertujuan untuk melindungi sistem dari serangan Brute Force dan Credential Stuffing.
 * Jika sebuah IP melampaui batas percobaan register yang ditentukan, sistem akan
...
const registerLimiter: RateLimitRequestHandler = rateLimit({
  ...
  windowMs: env.REGISTER_LIMIT_DURATION_TIME,

  // Batas maksimal percobaan (request) login per IP dalam rentang waktu windowMs
